...
creds = ServiceAccountCredentials.from_json_keyfile_name('odyssey/static/odyssey/credentials.json', scope)
...
def register_view(request):
    if request.method == "POST":
        ...
        messages.success(request, "Congratulations! You've successfully booked!")
